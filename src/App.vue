...
<template>
  ...
  <main v-else class="dashboard">
    <header>
      <h1>LE GUIDE DES FOURCASTER <span class="version-tag">V61</span></h1>
      <div class="user-info">
    ...
    <div class="main-layout">
      ...
      <div class="results-column">
        ...
        <div v-if="deepFavoriteResult" class="card result-spec-card" style="border-top:4px solid #fdd835;">
          ...
          <div v-if="deepFavoriteResult.data === null"><p>Ce favori n'est jamais sorti sur la période.</p></div>
          <div v-else>
        ...
        <section v-if="standardResult" class="card results-card fade-in">
          ...
          <div v-if="standardResult.ai_strategic_profile" class="ai-analysis"><h3>🧠 Profil</h3><p>{{ standardResult.ai_strategic_profile }}</p></div>
